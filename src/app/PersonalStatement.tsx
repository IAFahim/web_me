    ...
    return (
        <>
            ...
            <p className={"m-2 font-[family-name:var(--font-geist-sans)]"}>
                ...
                After
                that, I started getting the admiration of my teachers and did quite well in my studies, which were the
                source of my pride and determination. During that time, I placed my trust in a female classmate, and we
                attempted to take on AI as my research subject. Unfortunately, I was abandoned by the person, and with
                my
                ...
                life
                decisions to be written by me, and I enrolled in courses focused on ML and AI. It was different seeing a
                machine guessing like a human, where there are so many paths to explore. I recovered and found a goal in
            ...
            <p className={"m-2 font-[family-name:var(--font-geist-sans)]"}>
                ...
                me.
                Currently, I am studying advanced Python and practising Deep Learning, LLM, and AI Agents, hoping to be
                helpful as soon as I join my higher studies. For my journey, I would have to leave my life here to
                travel to
                a different place to study. However, travelling has been a passion of mine since I was young. Travelling
                and
                visiting a new place always gives me a rush of lasting happiness, a thing I learned by going to every
                corner
